...
public class MovieTheaterController : ControllerBase
{
    ...
    [HttpPost]
    public IActionResult AddMovieTheater([FromBody] CreateMovieDto movieTheaterDto)
    {
        ...
        return CreatedAtAction(nameof(GetMovieById), new { Id = movieTheater.MovieTheaterId }, movieTheaterDto);
    }
    ...
    public IActionResult GetMovieById(int id)
    {
        ...
        MovieTheater movieTheater = _context.MovieTheaters.FirstOrDefault(movieTheater => movieTheater.MovieTheaterId == id);
